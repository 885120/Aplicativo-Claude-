...
====================================================
Consolida os testes construidos nas auditorias de 12 a 15/09/2026.
...
ele nao volte. Tres vezes durante a auditoria um teste "falhou" e o APP estava certo —
o teste e que estava mal calibrado. Por isso cada caso tem um comentario dizendo o que
ele protege: antes de "consertar" o app por causa de uma falha aqui, confirme que a
expectativa do teste e que nao esta errada.
...
def g_utd(pg):
    ...
    def cena(pel, ure=''):
        setv(pg,'ePel',pel); setv(pg,'eUre',ure); pg.wait_for_timeout(200)
    ...
    reg(G,"Pelve 0,5 isolada = A1","a1", cena('0.5',''))
